...
flowchart TD
    ...
    B --> C[Ввод выражения]
    C --> D[Поиск всех токенов<br>числа, операторы, функции,<br>константы, скобки, переменные]
    D --> E[Сортировка токенов<br>по позиции в выражении]
    E --> F{Есть переменная X?}
    F -- Да --> G[Ввод значения X]
    F -- Нет --> H[Установка X = 0]
    G --> I
    H --> I
    I[Определение унарного минуса] --> J[Преобразование в<br>обратную польскую запись]
    J --> K[Вычисление выражения]
